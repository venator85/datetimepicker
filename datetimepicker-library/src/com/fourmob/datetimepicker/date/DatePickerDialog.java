...
public class DatePickerDialog extends DialogFragment implements View.OnClickListener, DatePickerController {
	...
	private void updateDisplay(boolean announce) {
		...
		if (mDayOfWeekView != null){
			mCalendar.setFirstDayOfWeek(mWeekStart);
			mDayOfWeekView.setText(mDateFormatSymbols.getWeekdays()[mCalendar.get(Calendar.DAY_OF_WEEK)].toUpperCase(Locale.getDefault()));
		}

		mSelectedMonthTextView.setText(mDateFormatSymbols.getMonths()[mCalendar.get(Calendar.MONTH)].toUpperCase(Locale.getDefault()));
